...
park_list = [
            ...
            # "Cabo de Gata-Níjar",
            # "Poor Knights Islands Marine Reserve, NO, NZ",
            # "Gorongosa National Park, MZ",
            # "Nyungwe Forest National Park",
            # "Klein Duin Section - Richtersveld National Park, NC, ZA",
            # "Hortobágyi",
            # "Uvs Nuur",
            # "Taman Negara Bako National Park, SK",
            # "Phu Kradueng",
            # "noel Kempff Mercado",
            ...
            # "Arcipelago Toscano National Park, IT",
            # "Zoni Eidikis Prostasias Chersonisos Akama Natura 2000 SPA, CY",
            # "Asinara National Park",
            # "RB ESP 19. Reserva de la Biosfera Las Bárdenas Reales de Navarra. Navarra. España",
            # "Parco nazionale del Golfo di Orosei e del Gennargentu",
            # "Mantadia wider area",
            # "Odzala-Kokoua & Lossi Landscape",
            # "Great Himalayan",
            # "Lagodekhi, KA, GE",
...
# Run Pipeline
print("Starting iNaturalist Data Pipeline...")

# 1. Fetch park internal IDs
place_ids = fetch_park_id(park_list)

# 2. Save details about the locations
get_places(place_ids)

# 3. Fetch and save raw observations directly to the Data/ folder
get_observations(place_ids, days_back)

print("Pipeline execution finished successfully. Ready for Git commit.")